...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=5cm]{fig-interferometro.pdf}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[width=5cm]{fig-interferometro-2.pdf}
\end{center}
...
\begin{figure}[!h]
\centerline{\psfig{file=fig-diagrama-espaciotiempo.pdf,height=5cm,angle=0}}
...
y llegada $T_2$.
\begin{figure}[!h]
\centerline{\psfig{file=fig-diagrama-definicion-x-y-t.pdf, height=5cm,angle=0}}
...
\begin{figure}[H]
\centerline{\psfig{file=fig-diagrama-factor-k.pdf,height=5cm,angle=0}}
...
\begin{figure}[H]
\centerline{\psfig{file=fig-diagrama-velocidad-relativa.pdf,height=5cm,angle=
0 } }
...
\begin{figure}[!h]
\centerline{\psfig{file=fig-diagrama-composicion-velocidades.pdf,height= 5cm,
angle=0}}
...
\begin{figure}[!h]
\centerline{\psfig{file=fig-fizeau.pdf,height=5cm,angle=0}}
...
\begin{figure}[!h]
\centerline{\psfig{file=fig-diagrama-boost.pdf,height= 5cm,
angle=0}}
...
\begin{figure}[H]
\centerline{\psfig{file=fig-diagrama-simultaneidad-01.pdf,height= 5cm,angle=0}}
...
\begin{figure}[H]
\centerline{\psfig{file=fig-diagrama-simultaneidad-02.pdf,height= 5cm,angle=0}}
...
\begin{figure}[!h]
\centerline{\psfig{file=fig-diagrama_simultaneidad-03.pdf,height= 4cm,angle=0}\hspace{1cm}\psfig{file=fig-diagrama_simultaneidad-04.pdf,height= 4cm,angle=0}}
...
\begin{figure}[!h]
\centerline{\psfig{file=fig-diagrama-dilatacion-01.pdf,height= 4cm,
angle=0}\hspace{1cm}\psfig{file=fig-diagrama-dilatacion-02.pdf,height=4cm,
angle=0}}
...
\begin{figure}[!h]
\centerline{\psfig{file=fig-diagrama-contraccion.pdf,height= 5cm,angle=0}}
...
\begin{figure}[!h]
\centerline{\psfig{file=fig-cono-de-luz-1D.pdf,height= 5cm,
angle=0}}
...
\begin{figure}[t]
\centering\epsfig{file=fig-cono-de-luz-2D.pdf, height=7cm}\caption{Cono de Luz, en 2+1 dimensiones.}
\end{figure}
...
\begin{figure}[ht]
\centerline{\psfig{file=fig-Compton.pdf,height=4cm,angle=0}}
...
\begin{figure}[h!]
\centerline{\psfig{file=fig-no-emision.pdf,height=4cm,angle=0}}
