...
En t'erminos de campos, se genera un campo el'ectrico $\vec{E}$ que es el que
...
\end{equation}
y la ley (\ref{divB}) (que asumimos v'alida incluso en el caso din'amico) para reescribir (\ref{dPhidt0}) como
\begin{eqnarray}
