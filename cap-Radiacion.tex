...
\end{equation}
\begin{figure}[H]
\centerline{\psfig{file=fig/fig-carga-relativista.pdf,height=6cm}}
...
\end{equation}
\begin{figure}[H]
\centerline{\psfig{file=fig/fig-Thomson.pdf,height=6cm}}
...
Para el caso de electrones, la secci'on tranversal total de Thomson tiene el valor $\sigma_{\rm T}\approx 6.65\times 10^{-29}$ m$^2$ y $r_q\approx 2.82\times 10^{-15}$ m es el llamado \textit{radio cl'asico del electr'on}.
...
\begin{figure}[!h]
\centerline{\psfig{file=fig/fig-Thomson-modelos.pdf,height=5cm}}
