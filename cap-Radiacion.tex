...
\begin{figure}[!h]
\centerline{\psfig{file=fig-cono-de-luz-01.pdf,height=5.5cm,angle=0}}
\caption{Cono de luz}
\label{fig:cdl2}
\end{figure}
...
\begin{figure}[ht]
\centerline{\psfig{file=fig-cono-de-luz-02.pdf,height=5.5cm,angle=0}}
...
\begin{figure}[ht]
\centerline{\psfig{file=fig-vectores.pdf,height=5cm,angle=0}} \caption{}
\label{R7}
\end{figure}
...
\begin{figure}[!h]
\centerline{\psfig{file=fig-a-n-Erad.pdf,height=5cm,angle=0}}
...
\begin{figure}[!h]
\centerline{\includegraphics[height=5cm]{fig-Larmor.pdf}\hspace{1cm}
\includegraphics[height=5cm]{fig-Larmor-02.pdf}}
...
\begin{figure}[H]
\centerline{\psfig{file=fig-tiempos.pdf,height=1.5cm,angle=0}}
...
\begin{figure}[!h]
\centerline{\psfig{file=fig-movimiento_lineal.pdf,height=4cm,angle=0}}
...
\end{equation}
\begin{figure}[H]
% \centerline{\psfig{file=fig-lobulo-rel-01.pdf,height=8cm,angle=-90}}
\centerline{\psfig{file=fig-carga-relativista.pdf,height=5cm}}
...
$\hat{n}$.
\begin{figure}[H]
\centerline{\psfig{file=fig-thomson-esquema.pdf,height=5cm}}
...
\end{equation}
\begin{figure}[H]
\centerline{\psfig{file=fig-thomson2d.pdf,height=5cm}}
...
\begin{figure}[!h]
\centerline{\psfig{file=fig-thomson.pdf,height=5cm}}
...
\end{equation}
\begin{figure}[ht]
% \centerline{\psfig{file=fig-lobulo_beta_0.5.pdf,height=5cm,angle=0}}
\centerline{\psfig{file=fig-mas.pdf,height=5cm,angle=0}}
 \caption{L'obulo de radiaci'on para $m=1,\dots,5$, $\beta=0,5$.}
\label{TER2}
\end{figure}
\begin{figure}[ht]
\centerline{\psfig{file=fig-mas-potencia-total-comparacion.pdf,height=5cm,angle=0}}
...
\end{equation}
\begin{figure}[H]
\centerline{\psfig{file=fig-dipolo.pdf,height=5cm,angle=0}}
...
\begin{figure}[H]
\centerline{\psfig{file=fig-antena.pdf,width=0.4\textwidth}}
...
% \end{eqnarray}
\begin{figure}[H]
\centerline{\psfig{file=fig-antena-media-onda.pdf,width=0.5\textwidth}}
