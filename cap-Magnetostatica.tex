...
\begin{figure}[!h]
\centerline{\psfig{file=fig-flujo-cargas-01.pdf,height=4cm,angle=0}}
...
\begin{figure}[!h]
\centerline{\psfig{file=fig-Biot-Savart-01.pdf,height=6cm,angle=0}}
...
\end{equation}
\begin{figure}[!h]
\centerline{\psfig{file=fig-tubo-de-corriente.pdf,height=4cm,angle=0}}
...
corriente}
\begin{figure}[!h]
\centerline{\psfig{file=fig-B-conductor-recto-01.pdf,height=5cm,angle=0}}
...
\begin{figure}[!h]
\centerline{\psfig{file=fig-expansion-multipolar-magnetica-01.pdf,height=4cm,
angle=0 } }
...
\end{equation}
\begin{figure}[!h]
\centerline{\psfig{file=fig-campo-magnetico-espira.pdf,height=5cm,angle=0}\hspace{2cm}\psfig{file=fig-campo-dipolo-magnetico.pdf,height=5cm,angle=0}}
...
\begin{figure}[!h]
\centerline{\psfig{file=fig-espira-plana-01.pdf,height=4cm,angle=0}}
...
\begin{figure}[!h]
\centerline{\psfig{file=fig-corriente-magnetizacion-superficie.pdf,height=3cm,angle=0}\psfig{file=fig-corriente-magnetizacion-volumen.pdf,height=3cm,angle=0}}
...
\begin{figure}[!h]
\centerline{\psfig{file=fig-condicion-borde-magnetica-01.pdf,height=5cm,angle=0}}
...
\ref{fig-histeresis}.
\begin{figure}[!h]
\centerline{\psfig{file=fig-histeresis-01.pdf,height=6cm,angle=0}}
