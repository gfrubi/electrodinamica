% Adaptado por gr
% Versión original de A. Tsagkaropoulos: https://tikz.net/spherical_volume/
...
\begin{pgfonlayer}{foreground}  
    ...
    %    
    \tdplotdrawarc[tdplot_main_coords]{(O)}{\rvec+\drvec}{\phivec}{\phivec+\dphivec}{below, rotate=13}{$r\sin\theta\mathrm{d}\varphi$} 
\end{pgfonlayer}
