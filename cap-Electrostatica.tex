...
\caption{Campo el'ectrico de una esfera conductora neutra en un campo el'ectrico externo. El gr'afico de la izquierda (normalizado) fue creado usando \href{https://github.com/gfrubi/electrodinamica/blob/master/figuras-editables/fig-esfera-conductora-campo-externo-raw.py}{este script}.}
\label{fig:ecce}
\end{figure}
...
\begin{figure}[!h]
\centerline{\psfig{file=fig/fig-carga-imagen-03.pdf,height=6cm,angle=0}}
...
\end{equation}
\begin{figure}[!h]
\centerline{\psfig{file=fig/fig-carga-imagen-04.pdf,height=6cm,angle=0}
\hspace{1cm}
